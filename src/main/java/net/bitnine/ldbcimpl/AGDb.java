    ...
    public static class LdbcQuery1Handler
        ...
        public void executeOperation(LdbcQuery1 ldbcQuery1,
            ...
            String stmt = "-- " + ldbcQuery1.toString() +" \n" + 
                    ...
                    "      WHEN true THEN 'null' " +
                    "      ELSE array_to_json(array[uni.name, studyAt.\"classYear\", uniCity.name]) " +
                    "    END " +
                    "  ) AS unis, " +
                    "  friendCity, " +
                    "  distance " +
                    ...
                    "      WHEN true THEN 'null' " +
                    "      ELSE array_to_json(array[company.name, worksAt.\"workFrom\", companyCountry.name]) " +
                    "    END " +
                    "  ) AS companies, " +
                    "  unis, " +
                    "  friendCity, " +
    ...
    public static class LdbcQuery7Handler implements
        ...
        public void executeOperation(LdbcQuery7 ldbcQuery7, DbConnectionState dbConnectionState, ResultReporter resultReporter) throws DbException {
            ...
            String stmt = "-- " + ldbcQuery7.toString() +" \n" + 
              ...
              "WITH DISTINCT ON (id(liker)) liker, message, l.\"creationDate\" AS likeTime, person " +
    ...
    public static class LdbcQuery10Handler implements
        ...
        public void executeOperation(LdbcQuery10 ldbcQuery10,
            ...
            String stmt = "-- " + ldbcQuery10.toString() +" \n" +
              ...
              "((extract(month from (to_timestamp(friend.birthday / 1000) at time zone 'KST')) = " + ldbcQuery10.month() + " AND " +
              "extract(day from (to_timestamp(friend.birthday / 1000) at time zone 'KST')) >= 21) OR " +
              "(extract(month from (to_timestamp(friend.birthday / 1000) at time zone 'KST')) = (" + ldbcQuery10.month() + " % 12)+1 AND " +
              "extract(day from (to_timestamp(friend.birthday / 1000) at time zone 'KST')) < 22)) AND " +
              ...
              "WITH   person, friend, city.name AS personCityName, post, exists((post)-[:hasTagPost]->()<-[:hasInterest]-(person)) AS common " +
    ...
    public static class LdbcQuery12Handler implements
        ...
        public void executeOperation(LdbcQuery12 ldbcQuery12,
            ...
            String stmt = "-- " + ldbcQuery12.toString() +" \n" + 
                    ...
                    "  friend.firstName AS friendFirstName, " +
                    "  friend.lastName AS friendLastName, " +
                    "  array_to_json(array_remove(array_agg(DISTINCT tag.name), NULL)) AS tagNames, " +
